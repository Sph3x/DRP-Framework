const GarageUIApp = new Vue({
    ...
    methods: {
        ...
        CloseGarage() {
            ...
            axios.post("http://drp_garages/close_garage", {}).then((response) => {
        ...
        StoreVehicle() {
            this.showGarageMenu = false;
            axios.post("http://drp_garages/store_vehicle", {}).then((response) => {
                console.log(response);
            }).catch((error) => {
                console.log(error);
            });
        ...
        SelectThisVehicle(selectedIndex) {
            ...
            axios.post("http://drp_garages/select_vehicle", {
