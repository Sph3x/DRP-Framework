...
function UpdateVehicle(veh)
	if DoesEntityExist(veh) then
		...
		print(json.encode(allVehicleMods))
		-- TriggerServerEvent("DRP_Garages:UpdateVehicle", allVehicleMods)
	else
