...
DRPDoorsConfig.Doors = {
    ...
    [5] = {model = "v_ilev_ph_gendoor005", x = 444.06, y = -989.48, z = 30.68, isLocked = true, doorRank = 2}, -- DOWNSTAIRS HALLWAY DOOR
    ...
    [10] = {model = "v_ilev_gtdoor", x = 464.16, y = -1003.51, z = 24.91, isLocked = true, doorRank = 2}, -- BACK ENTRANCE CELLS
