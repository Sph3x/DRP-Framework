...
AddEventHandler("ISRP_CharactersMenu:OpenCreator", function(models, gender)
...
-- Functions
---------------------------------------------------------------------------
function modelRunner(coolModel)
    local model = GetHashKey(coolModel)
    RequestModel(model)
    ...
    Citizen.Wait(1000)
    SetupManualCharacter(coolModel)
end

function SetupManualCharacter(model)
