...
Citizen.CreateThread(function()
	while true do
		for i=1, #DRPCoreConfig.RealWeapons do
            weaponHash = DRPCoreConfig.RealWeapons[i].hash
            weaponName = DRPCoreConfig.RealWeapons[i].name
...
function SetGear(weapon)
	...
	for i=1, #DRPCoreConfig.RealWeapons, 1 do
		if DRPCoreConfig.RealWeapons[i].name == weapon then
			bone     = DRPCoreConfig.RealWeapons[i].bone
			boneX    = DRPCoreConfig.RealWeapons[i].x
			boneY    = DRPCoreConfig.RealWeapons[i].y
			boneZ    = DRPCoreConfig.RealWeapons[i].z
			boneXRot = DRPCoreConfig.RealWeapons[i].xRot
			boneYRot = DRPCoreConfig.RealWeapons[i].yRot
			boneZRot = DRPCoreConfig.RealWeapons[i].zRot
			model    = DRPCoreConfig.RealWeapons[i].model
			break
		end
	end
